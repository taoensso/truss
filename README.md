...
- `2025-03-03` `v2.0.5`: [release info](../../releases/tag/v2.0.5) (v2 expands Truss's scope from just inline assertions to a general toolkit for Clojure/Script errors)
